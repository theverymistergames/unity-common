...
namespace MisterGames.Blueprints.Runtime {
    ...
    public sealed class RuntimeBlueprint : IBlueprint {
        ...
        internal void CallLink(int index, NodeId caller) {
            ...
            if (factory.GetSource(link.source) is not IBlueprintEnter enter) return;
        ...
        public override string ToString() {
            return $"{nameof(RuntimeBlueprint)}: Root: {root}\nNodes: {nodeStorage}\nLinks: {linkStorage}";
        }
    }

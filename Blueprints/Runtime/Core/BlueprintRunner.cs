...
namespace MisterGames.Blueprints {
    ...
    public sealed class BlueprintRunner : MonoBehaviour, IBlueprintHost {
        ...
        [SerializeReference] private BlueprintMeta _rootMetaOverride;
        ...
        private BlueprintCompiler _compiler2;

        public RuntimeBlueprint GetOrCompileBlueprint() {
            ...
            if (_blueprintAsset != null) {
                ...
                _compiler2 ??= new BlueprintCompiler();
#if UNITY_EDITOR
...
#if UNITY_EDITOR
        internal RuntimeBlueprint RuntimeBlueprint => _runtimeBlueprint;
        ...
        internal BlueprintMeta RootMetaOverride {
            get {
        ...
        internal NodeId[] FindSubgraphPath(BlueprintMeta meta) {

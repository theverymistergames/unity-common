...
namespace MisterGames.Blueprints.Nodes {
    ...
    public class BlueprintSourceInput :
        BlueprintSource<BlueprintNodeInput>,
        BlueprintSources.IInternalLink<BlueprintNodeInput>,
        BlueprintSources.IConnectionCallback<BlueprintNodeInput>,
        BlueprintSources.ICloneable { }

    [Serializable]
    [BlueprintNode(Name = "Input", Category = "External", Color = BlueprintColors.Node.External)]
    public struct BlueprintNodeInput : IBlueprintNode, IBlueprintInternalLink, IBlueprintConnectionCallback {

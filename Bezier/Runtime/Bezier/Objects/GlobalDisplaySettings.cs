...
{
    [CreateAssetMenu(fileName = nameof(GlobalDisplaySettings), menuName = "MisterGames/Bezier/" + nameof(GlobalDisplaySettings))]
    public class GlobalDisplaySettings : ScriptableObject
    {
        ...
        public static GlobalDisplaySettings Load() {
            ...
            var asset = AssetDatabase.LoadAssetAtPath<GlobalDisplaySettings>(path);
            return asset;
        }
#endif

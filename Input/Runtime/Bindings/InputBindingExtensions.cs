...
namespace MisterGames.Input.Bindings {
    ...
    public static class InputBindingExtensions {
        ...
        {
            (string deviceLayoutName, string controlPath) = axisBinding switch {
            ...
            controlPath = dir switch {
                ...
                AxisBingingDirection.UpDown => $"{controlPath}/y",
                AxisBingingDirection.LeftRight => $"{controlPath}/x",

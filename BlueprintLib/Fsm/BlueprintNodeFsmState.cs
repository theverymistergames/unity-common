...
namespace MisterGames.BlueprintLib {
    ...
    [Serializable]
    [BlueprintNode(Name = "Fsm State 2", Category = "Fsm", Color = BlueprintColors.Node.Flow)]
    public sealed class BlueprintNodeFsmState2 : IBlueprintNode, IBlueprintEnter, IBlueprintFsmState {

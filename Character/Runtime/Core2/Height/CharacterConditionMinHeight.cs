...
namespace MisterGames.Character.Core2.Height {
    ...
    [Serializable]
    public sealed class CharacterConditionMinHeight : ICondition {

        [Min(0f)] public float minHeight;

        public bool IsMatched => CharacterAccessProvider.CharacterAccess.HeightPipeline.Height >= minHeight;

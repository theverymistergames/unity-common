    ...
    public sealed class ClearDialoguePrintersAction : IActorAction {
        ...
        public UniTask Apply(IActor context, CancellationToken cancellationToken = default) {
            ...
            if (dialogueLauncher == null) {
                Debug.LogError($"ClearDialoguePrintersAction.Apply: f {UnityEngine.Time.frameCount}, cannot find dialogue launcher by id {dialogueLauncherId}");
                return default;
            }
            
            dialogueLauncher.ClearAllText();

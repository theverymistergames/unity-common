...
namespace MisterGames.Common.Localization {
    ...
    public sealed class LocalizationTableStorage : LocalizationTableStorageBase, ILocalizationTableStorage<string> {
        ...
        public bool TryGetValue(int keyIndex, int localeIndex, out string value) {
            ref var valueRow = ref _valueRows[keyIndex];
